...
class ZenFrameActionsMixin:
    ...
    def create_actions(self):
        ...
        self.mFrameAboutAction = self.create_action(
            "About", self.frameAboutAction, "About the zenframe2 library"
        )
    ...
    def openAction(self):
        curopen = self.current_opened()
        path = zenframe2.util.open_file_dialog(
            self,
    ...
    def saveAsAction(self):
        path, template = zenframe2.util.save_file_dialog(self)

...
from zenframe2.inotifier import InotifyThread
from zenframe2.screen_saver import ScreenSaverWidget
from zenframe2.console import ConsoleWidget
from zenframe2.text_editor import TextEditor
from zenframe2.client import Client
...
# TEST
    ...
    def hello(self):
        print("hello")
        import zenframe2.unbound
        zenframe2.unbound.BOTTOM_HALF_TEST()

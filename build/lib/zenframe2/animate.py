...
class AnimateThread(QThread):
    ...
    def __init__(self, updater, step, debug_mode=False):
        ...
        zenframe2.finisher.register_destructor(self, self.finish)
    ...
    def finish(self):
        if self.debug_mode:
            zenframe2.util.print_to_stderr("AnimateThread::Finish")
        self.cancelled = True
        self.wait()
    ...
    def run(self):
        ...
        while 1:
            ...
            if self.cancelled:
                if self.debug_mode:
                    zenframe2.util.print_to_stderr("AnimateThread::return")
                return
